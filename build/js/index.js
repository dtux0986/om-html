...
var _smoothscrollForWebsites = __webpack_require__(3);
...
om.smoothscroll = function () {
	new _smoothscrollForWebsites2.default();
};

om.carousel = function () {
	_slick2.default.testimonials();
};

om.parallax = function () {
	_scrollmagic2.default.parallax();
};
...
Carousel.testimonials = function () {
	...
	var slider = '.o-testimonials__slider';
...
SM.parallax = function () {
	...
	new _scrollmagic2.default.Scene({ triggerElement: "#o-parallax" }).setTween("#o-parallax .o-parallax__background", { y: "70%", ease: Linear.easeNone }).addTo(controller);
};
